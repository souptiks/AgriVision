...
def model_prediction(test_image):
    model = tf.keras.models.load_model("D:\Project_7th_Sem\Fruits_Data_Set\traning_model.h5")
...
# About Project Page
        ...
        st.header("About Project")
        st.subheader("About Dataset")
        st.text("This dataset encompasses images of various fruits and vegetables, providing a diverse collection for image recognition tasks.")
        st.code("Fruits: Banana, Apple, Pear, Grapes, Orange, Kiwi, Watermelon, Pomegranate, Pineapple, Mango")
